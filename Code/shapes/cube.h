...
public:
    ...
    Cube(const Matrix4x4& transform, const Matrix4x4& inv_transform, const Material& mat, const Vector3& velocity, double shutter_time); // 'public' is a c++ keyword that makes members accessible from outside the class.
